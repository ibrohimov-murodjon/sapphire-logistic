  ...
  return (
    <div className=" py-[30px] px-[50px] calculation-slider mobileLg:flex mobileLg:flex-col mobileLg:items-center">
      <div className="flex flex-col mobileLg:items-center mobileLg:justify-center ">
        <h1 className="text-4xl text-black font-semibold mobileLg:text-3xl mobileLg:text-center w-full  mobileLg:max-w-[300px]">{data?.name}</h1>
      ...
      <div className="flex items-center gap-4 mt-10">
        ...
        <span className="text-[#242525] text-[24px] font-bold mobileLg:w-full mobileLg:text-[14px] mobileLg:max-w-[50px] mobileLg:text-center mobileMd:text-[10px]">{`0${data.id} / 4`}</span>
        <button onClick={next}>

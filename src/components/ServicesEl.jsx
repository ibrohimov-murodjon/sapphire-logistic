const ServicesEl = ({ data }) => {
  return (
    <div className="flex items-start justify-around mt-9 h-[400px] overflow-y-hidden gap-x-8 mobileMax:flex-col mobileMax:items-center mobileMax:h-fit">
      ...
      <img src={data.img} className="w-[480px] h-[370px] object-cover mobileMax:w-[500px] mobileMax:h-[300px] mobileLg:h-[280px] mobileMd:h-[210px]" />
      </span>
      ...
      <span>
        ...
        <p className="w-full max-w-[450px] text-[17px] text-[#fff] maxSm:text-[15px] mobileMax:text-center">
          {data.text}
        </p>
      </span>
    </div>

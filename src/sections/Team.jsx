...
const Team = () => {
  return (
    <div className='pb-32 pt-48 bg-white'>
        ...
        <h1 className='text-center  text-[40px] font-bold w-full max-w-[600px]'>Meet the core team members who runs Sapphire</h1>
        <ul className="flex items-center gap-4  mt-10 mb-10">
            <li className='group relative '>
                <img src={AboutSlide1} className="h-[350px] w-[250px] relative" alt="" />
                ...
                <h5 className='font-bold uppercase text-[18px] text-white'>Maxim Johnson</h5>
                <p className='font-bold text-[14px] text-white'>Head of Operation</p>
                </span>
            </li>
            <li className='group relative'>
                <img src={AboutSlide1} className="h-[350px] w-[250px] relative" alt="" />

      ...
      >
        <SwiperSlide className="slider1 hero-swiper">
          <div className="flex mx-auto w-full max-w-[1246px] px-[20px] flex-col">
            ...
            <h1 className="flex flex-wrap leading-[80px] items-center  text-[64px] font-bold text-white w-full max-w-[450px] mb-2 mobileMax:text-[50px] mobileMax:leading-[60px] mobileLg:text-[40px] mobileLg:leading-[45px] mobileMd:text-[30px] mobileMd:leading-[35px]">
